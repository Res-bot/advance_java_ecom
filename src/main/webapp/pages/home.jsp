...
<%-- 
    NOTE: The taglib directive above is added if you intend to use JSTL EL expressions 
    for cleaner access to session attributes and context paths. 
    It is a best practice replacement for using pure scriptlets with request.getSession().getAttribute("email").
    I have kept the original scriptlet logic as you provided it, but added the taglib for potential future use.
--%>
...
<body>
    <header class="header">
        ...
        <div class="icons">
            ...
            <div class="login">
                <a href="login.jsp">
                    <button class="fas fa-sign-in-alt">Login</button>
                </a>
            </div>
            <% } %>
